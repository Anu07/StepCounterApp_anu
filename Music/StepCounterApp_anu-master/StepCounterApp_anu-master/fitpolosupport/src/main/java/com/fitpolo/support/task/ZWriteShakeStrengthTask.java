...
public class ZWriteShakeStrengthTask extends OrderTask {
    ...
    public ZWriteShakeStrengthTask(MokoOrderTaskCallback callback, int shakeStrength) {
        super(OrderType.WRITE_CHARACTER, OrderEnum.Z_WRITE_SHAKE_STRENGTH, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
        orderData = new byte[ORDERDATA_LENGTH];
        orderData[0] = (byte) MokoConstants.HEADER_WRITE_SEND;
        orderData[1] = (byte) order.getOrderHeader();
        orderData[2] = (byte) 0x01;
        orderData[3] = (byte) shakeStrength;
    }
