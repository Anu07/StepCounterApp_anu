...
class WalletViewModel(application: Application) : AndroidViewModel(application) {
    private var mDelete: MutableLiveData<BasicWishListResponse>? = null
    ...
    fun getDeleteResponse(): MutableLiveData<BasicWishListResponse> {
        mDelete = MutableLiveData()
        return mDelete as MutableLiveData<BasicWishListResponse>
    }
...
//                mTokenModel!!.value = null
                    ...
                    override fun onResponse(
                        ...
                        when {
                            response!!.code() == 200 -> mTokenModel!!.value = response.body()!!
                            response.code() == 405 -> {
                                Toast.makeText(
                                    HayaTechApplication.applicationContext(),
                                    "User doesn't exist",
            ...
            call!!.redeemNow(request).enqueue(object : Callback<PurchaseResponse> {
                ...
                override fun onResponse(
                    ...
                    when {
                        ...
                        else -> mPurchaseResponse!!.value = PurchaseResponse()
                    }
                }
            })
        }
    ...
    fun hitDeleteApi(redeemRequest: RedeemRequest) {
        if (Utils.retryInternet(HayaTechApplication.applicationContext())) {
            ...
            call!!.deleteWishList(redeemRequest).enqueue(object : Callback<BasicWishListResponse> {
